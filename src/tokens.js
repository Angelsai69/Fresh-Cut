export const tokens = {
  ...
  elevation: {
    0: 'none',
    1: (dark) => dark ? '0 2px 16px rgba(0,0,0,0.28)' : '0 2px 16px rgba(15,43,70,0.06)',
    2: (dark) => dark ? '0 8px 32px rgba(0,0,0,0.42)' : '0 8px 32px rgba(15,43,70,0.10)',
    3: (dark) => dark ? '0 16px 48px rgba(0,0,0,0.55)' : '0 16px 48px rgba(15,43,70,0.15)',
  },
}
